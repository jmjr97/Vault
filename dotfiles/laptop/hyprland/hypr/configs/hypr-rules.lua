...
-- hl.window_rule({ match = { class = 'com.gabm.satty' }, float = true, center = true, size = default_size })
hl.window_rule({ match = { class = 'com.gabm.satty' }, float = true })
hl.window_rule({ name = 'floater', match = { float = true }, center = true, size = smaller_size })
